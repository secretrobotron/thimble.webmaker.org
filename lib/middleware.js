  ...
  return {
    ...
    finalizeProject: function(nunjucksEnv, env) {
      ...
      return function(req, res, next) {
        ...
        // EXPERIMENTAL HACK FOR WEBCOMPONENTS
        var wc = "<script src=\"http://pomax.github.io/WebComponentDemo/platform/WebComponents/web-components.js\"></script>\n";
        var ce = "<script src=\"http://pomax.github.io/WebComponentDemo/platform/CustomElements/custom-elements.js\"></script>\n";
        finalized = finalized.replace("</body", wc + ce + "</body");
        // END EXPERIMENTAL HACK FOR WEBCOMPONENTS
